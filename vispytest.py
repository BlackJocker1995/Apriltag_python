...
class Canvas(app.Canvas):
    ...
    def __init__(self, **kwargs):
        ...
        app.Canvas.__init__(self, keys='interactive', size=(720, 720),
                            **kwargs)
        ps = self.pixel_scale
        self.position = 50, 50
        ...
        edges = np.array([[1, 2], [1, 3], [1, 4]], dtype='uint32')
        # data['a_position'] = np.hstack((.25 * np.random.randn(n, 2),
        #                                np.zeros((n, 1))))
        data['a_position'] = 0.0005*np.array([[300.0,300.0,300.0],[0,0,0],[1000.0,0,0],[0,1000,0],[0,0,1000]])
